...
public class Complex
{
    ...
    public Complex log()
    {
    		double rpart=StrictMath.sqrt(this.re*this.re+this.im*this.im);
            double ipart=StrictMath.atan2(this.im,this.re);
    ...
    {
    	Complex a=(this.log()).times(d);
    	return a.exp();
    }
    
    public double degreetheta()
    {
